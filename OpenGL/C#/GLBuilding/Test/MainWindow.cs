...
namespace Test
{
    public partial class MainWindow : Form
    {
        ...
        private void AnT_ClientSizeChanged(object sender, EventArgs e)
        {
            // сохранение коэффициентов, которые нам необходимы для перевода координат указателя в оконной системе в координаты, 
            // принятые в нашей OpenGL сцене 
            devX = (float)ScreenW / (float)AnT.Width;
        ...
        private void Draw()
        {
            ...
            PrintText2D((float)(devX * Mcoord_X + 0.2f),(float) (ScreenH - devY * Mcoord_Y + 0.4), "[ x: " + (devX * Mcoord_X - 15) + " ; y: " + ((float)ScreenH - devY * Mcoord_Y - 15) + "]");
