...
namespace PoluPoker
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                _tables.Add(new GameTable.GameTable()
                {
                    TableText = $"table{i+1}"
                });
            }
        ...
        {
            GameTablesPanel.Controls.Add(new GameTable.GameTable());
        }

        private void panel1_MouseEnter(object sender, EventArgs e)
        {
            OnEnterMouse(panel1, _defaulRollUpBtn);
        }
        ...
        {
            OnLeaveMouse(panel1, _defaulRollUpBtn);
        }
